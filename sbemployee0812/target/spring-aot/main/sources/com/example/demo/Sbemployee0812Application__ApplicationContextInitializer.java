 ...
 */
@Generated
public class Sbemployee0812Application__ApplicationContextInitializer implements ApplicationContextInitializer<GenericApplicationContext> {
  @Override
  public void initialize(GenericApplicationContext applicationContext) {
    ...
    new Sbemployee0812Application__BeanFactoryRegistrations().registerBeanDefinitions(beanFactory);
    new Sbemployee0812Application__BeanFactoryRegistrations().registerAliases(beanFactory);
  }
