...
*圖1：Swagger UI依Controller分組列出API；藍、綠、橘、紅色區塊分別對應GET、POST、PUT與DELETE，而不是程式碼的顏色分類。*
...
*圖2：Tag設定Controller分組名稱與說明，Operation則補充單一端點的summary與description；它們不會改變API實際邏輯。*
