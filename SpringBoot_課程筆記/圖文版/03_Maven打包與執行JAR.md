# Spring Boot 圖文學習筆記 03：Maven 打包與執行 JAR
...
![Eclipse中的Maven install](../圖文版素材_待製作/images/18_MavenInstall選單.png)

*圖1：Maven install負責建置與安裝成品，不是啟動Spring Boot服務。*
...
![target中的Spring Boot JAR](../圖文版素材_待製作/images/20_target打包產物.png)

*圖2：命令列啟動時使用沒有`.original`的可執行JAR。*
...
*圖3：畫面能證明啟動失敗；仍須查看最下方Description或連接埠結果才能確認根因。*
