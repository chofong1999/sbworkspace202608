...
本章接續原生JavaScript DOM與Event，使用jQuery簡化元素選取、事件註冊、內容修改、樣式、節點包裝及表格建立。範例檔案位於`day3`，對應`jquery_basic.html`到`jquery_mouse.html`。

> 語法速查：[jQuery](../語法字典/13_jQuery與AJAX.md)
